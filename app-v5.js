...
const SCOPES = [
  ...
  'playlist-modify-private',  // private playlists — fewer API restrictions, playlist is ephemeral anyway
  'user-library-read',
...
function saveTok(d) {
  ...
  ls.s('ts_tok', { ...d, exp: Date.now() + d.expires_in * 1000, has_write: granted.has('playlist-modify-private') });
}
